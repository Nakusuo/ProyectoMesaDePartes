...
-- Incluye: Derivaciones, Notificaciones, Trazabilidad, Reportes y BITÁCORA
-- =====================================================
...
-- =====================================================
SELECT '✅ Base de datos creada exitosamente con BITÁCORA incluida' AS mensaje;
SELECT '' AS separador;
...
SELECT '✅ Triggers configurados correctamente (derivación + bitácora)' AS mensaje;
SELECT CONCAT('📊 ', COUNT(*), ' registros históricos insertados en bitácora') AS mensaje FROM bitacora;

SELECT '' AS separador;
SELECT '🎉 ¡TODO LISTO! Sistema completo con BITÁCORA funcionando' AS mensaje_final;
