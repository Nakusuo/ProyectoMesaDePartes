...
CREATE TABLE documentos (
    ...
    numero_registro INT NOT NULL UNIQUE, -- ¿Debería ser generado por el backend?
    ...
    -- Campos de responsable y salida eliminados --
...
CREATE TABLE salidas_documento (
    ...
    ID_documento INT UNSIGNED NOT NULL, -- Documento de entrada al que responde
    ID_tipo_documento INT UNSIGNED, -- Tipo del documento de SALIDA
...
-- ==========================
-- DATOS DE PRUEBA (sin cambios, excepto eliminar los DROP al final)
-- ==========================
...
INSERT INTO documentos (numero_registro, fecha_documento, ID_tipo_documento, numero_documento, remitente, asunto, ID_usuario_registro)
VALUES
(1,'2025-09-01',1,'256','DIRANDRO','Solicitud de combustible',1),
(2,'2025-09-05',2,'123','DIRCRI','Envío de resultados de pericia',2),
(3,'2025-09-10',3,'456','DIRNIC','Pedido de información adicional',1),
(4,'2025-09-12',4,'789','DIRAVPOL','Informe de operaciones aéreas',3),
(5,'2025-09-15',1,'987','DIREED','Solicitud de materiales educativos',1);